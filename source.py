...
def build_apple_report(
    source=os.path.join("apple_reports", "applemobilitytrends.csv"),
    report_type="regions",
):
...
def build_waze_report(
    countries_source=os.path.join("waze_reports", "Waze_Country-Level_Data.csv"),
...
def run():
    ...
    if new_files_status_google:
        ...
        google_brazil = build_google_report(
        ...
        google_world.to_csv(
            os.path.join("google_reports", "mobility_report_countries.csv"), index=False
        )
        ...
        google_US.to_csv(
            os.path.join("google_reports", "mobility_report_US.csv"), index=False
        )
        google_US.to_excel(
        ...
        google_brazil.to_csv(
            os.path.join("google_reports", "mobility_report_brazil.csv"), index=False
        )
        google_brazil.to_excel(
            os.path.join("google_reports", "mobility_report_brazil.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        google_europe.to_csv(
            os.path.join("google_reports", "mobility_report_europe.csv"), index=False
        )
        google_europe.to_excel(
            os.path.join("google_reports", "mobility_report_europe.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        google_asia_africa.to_csv(
            os.path.join("google_reports", "mobility_report_asia_africa.csv"),
            index=False,
        )
        google_asia_africa.to_excel(
            os.path.join("google_reports", "mobility_report_asia_africa.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        google_america_oceania.to_csv(
            os.path.join("google_reports", "mobility_report_america_oceania.csv"),
            index=False,
        )
        google_america_oceania.to_excel(
            os.path.join("google_reports", "mobility_report_america_oceania.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
    ...
    if new_files_status_apple:
        ...
        # write reports to CSV and Excel
        apple_world.to_csv(
            os.path.join("apple_reports", "apple_mobility_report.csv"), index=False
        )
        apple_world.to_excel(
            os.path.join("apple_reports", "apple_mobility_report.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        apple_US.to_csv(
            os.path.join("apple_reports", "apple_mobility_report_US.csv"), index=False
        )
        apple_US.to_excel(
            os.path.join("apple_reports", "apple_mobility_report_US.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
    ...
    if new_files_status_waze:
        ...
        waze.to_excel(
            os.path.join("waze_reports", "waze_mobility.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
    ...
    if new_files_status_apple or new_files_status_google:
        ...
        summary_regions = build_summary_report(
            os.path.join("apple_reports", "apple_mobility_report.csv"),
            os.path.join("google_reports", "mobility_report_countries.csv"),
        )
        summary_US = build_summary_report(
            os.path.join("apple_reports", "apple_mobility_report_US.csv"),
            os.path.join("google_reports", "mobility_report_US.csv"),
            "US",
        )
        ...
        summary_regions.to_csv(
            os.path.join("summary_reports", "summary_report_regions.csv"), index=False
        )
        summary_regions.to_excel(
            os.path.join("summary_reports", "summary_report_regions.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        summary_US.to_csv(
            os.path.join("summary_reports", "summary_report_US.csv"), index=False
        )
        summary_US.to_excel(
            os.path.join("summary_reports", "summary_report_US.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
        summary_countries.to_csv(
            os.path.join("summary_reports", "summary_report_countries.csv"), index=False
        )
        summary_countries.to_excel(
            os.path.join("summary_reports", "summary_report_countries.xlsx"),
            index=False,
            sheet_name="Data",
            engine="xlsxwriter",
        )
